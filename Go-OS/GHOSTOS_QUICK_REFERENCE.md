...
|--------|---------|----------|----------|
| 1 | v1.0 | Debian 12 base, Heck-CheckOS GUI, core features | ~10GB |
| 2 | v1.1 | Debian 12 base, enhanced privacy, Malwarebytes, improved UI | ~11GB |
| 3 | v2.0 | Debian 12 base, Wayland, AI, cloud backup, plugins, ARM | ~12GB |
